...
function Register() {
  ...
  const onUserRegister = async (userObj) => {
    ...
    // Add all user properties and files to this form data object
    ...
    <div className={`${pageBackground} flex items-center justify-center py-16 px-4`}>
      <div className={formCard}>
            ...
            <input
              ...
              {...register("profileImageUrl", {
                validate: {
                  ...
                  fileSize: (files) => {
                    if (!files?.[0]) return true;
                    return files[0].size <= 2 * 1024 * 1024 || "File exceeded maximum size 2MB";
                  },
                },
              })}
              onChange={(event) => {
        ...
        <p className={`${mutedText} text-center mt-5`}>
          ...
          <NavLink to="/login" className="text-purple-800 font-medium">
            Sign in
          </NavLink>
        </p>
      </div>
